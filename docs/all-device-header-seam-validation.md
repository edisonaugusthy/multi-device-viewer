...
- TypeScript and all **316 unit tests** pass. Chrome packages rebuilt and validated. This pass uses Chromium for visual tests; no claim of physical-device testing.
