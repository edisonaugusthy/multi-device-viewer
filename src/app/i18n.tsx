...
const en = {
  ...
  captureActiveViewport: "Capture active viewport",
  ...
  openPhysicalDevice: "Open on physical device",
  generateAiFixPrompt: "Generate AI fix prompt",
  capturingComparison: "Capturing comparison…",
  captureAndAnnotate: "Capture and annotate",
  startNewCheck: "Start a new check",
  recordingStop: "Recording {time} — stop",
  recordSourceTab: "Record source tab",
  takeFeatureTour: "Take a feature tour",
  recordingStatus: "REC · {time} · source tab",
  currentSession: "Current session",
  sessionSummary: "{count} viewports · {mode}",
  linked: "linked",
  ...
  scanSameNetwork: "Scan while the phone is on the same network.",
  closeDeviceHandoff: "Close device handoff",
  qrCurrentPage: "QR code for current page",
  localhostWarning: "localhost only works on this computer. Replace it with your computer’s LAN IP and make sure the dev server listens on your network.",
  ...
  tourViewportEyebrow: "Viewport",
  tourViewportTitle: "Use each preview like the real page",
  tourViewportText: "Change device, rotate, zoom, reload, focus one viewport, or resize the split between screens.",
  tourViewportHint: "The controls above each preview apply only to that viewport.",
  tourSyncEyebrow: "Synchronization",
  tourSyncTitle: "Check the same journey everywhere",
  tourSyncText: "Scroll sync keeps matching pages aligned. Navigation sync follows links across viewports, so one action can reveal layout differences.",
  tourSyncHint: "Active sync controls turn green.",
  tourFocusEyebrow: "Focus",
  tourFocusTitle: "Inspect one viewport without distractions",
  tourFocusText: "Focus active viewport temporarily shows only the selected preview, giving detailed layout and interaction checks the full canvas.",
  tourFocusHint: "Choose Show all viewports in the same place to return to the comparison.",
  tourDesignEyebrow: "Design review",
  tourDesignTitle: "Compare the live page with its design",
  tourDesignText: "Open Compare page to design to place an approved reference beside a viewport or overlay it directly on the live page.",
  tourDesignHint: "Adjust the reference size, position, and opacity to spot visual differences.",
  tourHandoffEyebrow: "Handoff",
  tourHandoffTitle: "Turn a problem into a clear handoff",
  tourHandoffText: "Compare against a design, capture and annotate evidence, record the source tab, open it on a phone, or copy an AI-ready fix prompt.",
  tourHandoffHint: "You can replay this tour from Take a feature tour.",
  ...
  releaseTourDescription: "An eight-step product tour now covers clearing the sidebar, focusing one viewport, comparing against a design, synchronization and handoff without clipping controls at the window edge.",
